...
from 0.6078 to 0.6690 on a separate 10-query test set.
\end{abstract}
...
Figure~\ref{fig:verdict-training} summarizes the offline training, and
Figure~\ref{fig:crawler-runtime} shows the crawl loop. For
\textsc{PageVerdict}, Qwen~2.5:7B labels provide weak supervision alongside
...
scoring. It is serialized with MessagePack. On the complete 10,027-document
index, MessagePack was 37\% smaller than compact JSON (57.4 vs.\ 91.6\,MB) and
had a 2.35-times lower median deserialization time over 20 runs (388 vs.\
910\,ms). For term $t$, document $d$, and fields $f$, BM25F computes
\[
...
in Table~\ref{tab:retrieval-evaluation} shows no effectiveness gain, the bonus is
...
development. Their BM25F and selected-system pools yield 267 further judgments;
the development pool contains 715. nDCG@20, MRR@10, and warmed API latency
...
\midrule
Dev. (20) & BM25F    & no  & no  & 0.5727 & 0.6023 & \textbf{0.9500} &  1.94 \\
 & BM25F + proximity & yes & no  & 0.5636 & 0.5925 & \textbf{0.9500} &  4.73 \\
 & BM25F + semantic  & no  & yes & \textbf{0.6441} & \textbf{0.7058} &
  0.9375 & 65.89 \\
 & Full              & yes & yes & 0.6345 & 0.6982 & 0.9375 & 68.08 \\
\midrule
Test (10) & BM25F    & no  & no  & 0.6078 & 0.6601 & 0.8111 & 2.06 \\
 & BM25F + semantic  & no  & yes & \textbf{0.6690} & \textbf{0.7677} &
  \textbf{0.8750} & 67.62 \\
\bottomrule
\end{tabular}
\end{table*}

Semantic re-ranking improves nDCG@10 by 0.0714 over BM25F, whereas proximity
...
\begin{figure*}[t]
  \centering
  \includegraphics[height=.34\textheight]{img/result_list.png}\hfill
  \includegraphics[height=.34\textheight]{img/star_constellation.png}\\[-1mm]
  {\scriptsize (a) Ranked result list.\hfill
  (b) Category-based star constellation.}
