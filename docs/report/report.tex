...
The search system
(\href{https://github.com/julilili42/search-engine/tree/final_submission}{\texttt{final\_submission}},
commit \href{https://github.com/julilili42/search-engine/commit/b5c78b0a12f56074c9d62badfb9c9812f7e24767}{\texttt{b5c78b0}}) and crawl-model training
(\href{https://github.com/julilili42/labeling-lab/tree/final_submission}{\texttt{final\_submission}},
commit \href{https://github.com/julilili42/labeling-lab/commit/a81e4957cf8ebe00183c47a51650002ee6dc1386}{\texttt{a81e495}}) are maintained in separate repositories.
...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    \node[box, fill=TUgold!12, right=of page-samples] (page-labels)
      {Qwen + human\\($n=2{,}538$)};
    \node[train, right=of page-labels] (page-train)
      {TF--IDF +\\logistic regression};
    \node[box, fill=TUblue!10, right=of page-train] (page-model)
      {\textsc{PageVerdict}};
    ...
    \node[box, fill=TUgold!12, right=of link-samples] (link-labels)
      {Human only\\($n=2{,}037$)};
    \node[train, right=of link-labels] (link-train)
      {TF--IDF +\\logistic regression};
    \node[box, fill=TUblue!10, right=of link-train] (link-model)
      {\textsc{LinkVerdict}};

    \draw[arrow] (page-samples) -- (page-labels);
    \draw[arrow] (page-labels) -- (page-train);
    \draw[arrow] (page-train) -- (page-model);
    \draw[arrow] (link-samples) -- (link-labels);
    \draw[arrow] (link-labels) -- (link-train);
    \draw[arrow] (link-train) -- (link-model);
  \end{tikzpicture}
  }
